...
const InforCustoOfTrips = () => {
  ...
  const dataOfShowTrips =
    location.state?.dataOfShowTrips || savedData?.dataOfShowTrips;
  ...
  useEffect(() => {
    if (departureTime) {
      const formattedTime = moment(departureTime, "DD/MM/YYYY, HH:mm")
        .tz("Asia/Ho_Chi_Minh")
        .format("HH:mm");
  ...
  useEffect(() => {
    if (departureTime2) {
      const formattedTime2 = moment(departureTime2, "DD/MM/YYYY, HH:mm")
        .tz("Asia/Ho_Chi_Minh")
        .format("HH:mm");
  ...
  }).format(totalAmountAllTowTrips);
  {
    selectedSeats.length > 0
      ? new Intl.NumberFormat("vi-VN", {
          style: "currency",
          currency: "VND",
        }).format(selectedSeats.length * totalAmount)
      : "";
  }
  ...
  const selectedDepartureName2 =
    schedule2.find((stop) => stop._id === selectedDeparture2)?.name2 || from2;
  const selectedDestinationName2 =
    schedule2.find((stop) => stop._id === selectedDestination2)?.name2 || to2;
  const handleCreateBooking = async () => {
    ...
    if (
      tripType === "Khứ hồi" &&
      (!selectedSeats2 || selectedSeats2.length === 0)
    ) {
      setAlert({
        open: true,
        severity: "error",
    ...
    try {
      const createBookingResponse = await axios.post(
        `${API_URL}/api/bookingRoutes/add`,
        bookingDataForPayment
      );
      let bookingId2;
      if (tripType === "Khứ hồi" && bookingDataReturn) {
        const createBookingReturnResponse = await axios.post(
          `${API_URL}/api/bookingRoutes/addRoutTrip`,
          bookingDataReturn
        );
      ...
      if (tripType === "Khứ hồi") {
        ...
        const formattedReturnTime = moment(dayMonthYear2, "D/MM/YYYY")
          .tz("Asia/Ho_Chi_Minh")
          .format("YYYY-MM-DDTHH:mm:ss.SSSZ");
        ...
        await axios.post(
          `${API_URL}/api/tripsRoutes/book-SeatsRoutTrip`,
          bookingDataReturn
        );
      }
                  ...
                  {userInfo ? (
                    ...
                    >
                      ...
                      <Button onClick={handleClickMenu}>
                        ...
                        >
                          {userInfo ? userInfo.fullName : "Chưa có thông tin"}
                        </Typography>
                      </Button>
                  ...
                  >
                      ...
                      >
                        ...
                        >
                          ...
                          <Typography
                            ...
                            sx={{ fontSize: "14px" }}
                          >
                            Số điện thoại và email được sử dụng để gửi thông tin
                            đơn hàng và liên hệ khi cần thiết.
                          </Typography>
                        </Box>
                      </Box>
                      <Box
                        ...
                        >
                          <FormControl>
                            ...
                            >
                              ...
                              Trước 30 phút để kiểm tra thông tin trước khi lên
                              xe.
                            </Typography>
                          </FormControl>
                          <Box
                        ...
                        >
                          ...
                          >
                            <FormControl>
                              ...
                              >
                                Quý khách vui lòng có mặt tại Bến xe/Văn Phòng
                                Trước 30 phút để kiểm tra thông tin trước khi
                                lên xe.
                              </Typography>
                            </FormControl>
                            <Box
                    ...
                    <Box>
                      ...
                      >
                        ...
                        >
                          <Typography
                            ...
                            sx={{ marginLeft: "18px", marginTop: "20px" }}
                          >
                            Tạm tính <span style={{ color: "red" }}>*</span>
                          </Typography>
                          <Typography
                            className="button35-5"
                        ...
                        {tripType !== "Khứ hồi" && (
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <Typography className="button38-1">
                                  {" "}
                                  {selectedSeats.length > 0
                                    ? new Intl.NumberFormat("vi-VN", {
                                        style: "currency",
                                        ...
                                        selectedSeats.length * totalAmount
                                      )
                                    : ""}{" "}
                                </Typography>
                                <Typography className="button38-1">
                              ...
                              <Typography className="button38-2">
                                {" "}
                                Mã ghế/giường: {SeatCode}
                              </Typography>
                            </Box>
                          </Box>
                        )}
                      ...
                      >
                        ...
                        >
                          <Typography
                            className="button38-3"
                            sx={{ color: "#647280", fontSize: "15px" }}
                          >
                            {" "}
                            Nhà xe
                          </Typography>
                        ...
                        >
                          ...
                          <Typography
                            className="button38-3"
                            sx={{ fontSize: "18px", color: "#c23003" }}
                          >
                            {" "}
                            {formattedTotalAmountAll}
                          </Typography>
                        </Box>
                      </Box>
                      {tripType === "Khứ hồi" && (
                ...
                <Box sx={{ width: "100%", backgroundColor: "white" }}>
                  ...
                  >
                    <Box sx={{ display: "flex", flexDirection: "column" }}>
                      ...
                      >
                        Bằng việc nhấn nút Tiếp tục, bạn đồng ý với Chính sách
                        bảo mật thanh toán và Quy chế
                      </Typography>
                    </Box>
                    <Typography
                      className="button36"
                    ...
                    >
                      Bạn sẽ sớm nhận được biển số xe, số điện thoại tài xế và
