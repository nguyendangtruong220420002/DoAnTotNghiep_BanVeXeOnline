...
const InforCustoOfTrips = (socket) => {
  ...
  const handleCreateBooking = async () => {
    ...
    try {
      ...
      socket.socket?.emit('update-get-seat', { tripId, bookingDate: formattedDepartureTime })
      setTimeout(() => {
        navigate('/payment', {
          state: {
            bookingId, bookingID, userInfo, from, schedule, to, endTime, selectedSeats, business,
