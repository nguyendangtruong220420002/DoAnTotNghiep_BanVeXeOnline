...
if (userInfo.img) { 
  ...
  return (
    <Box sx={{ display: 'flex', maxWidth: '1128px', justifyContent: 'space-around', alignItems: 'center', margin: '0 auto' }}>
      <Box sx={{ width: '252px', height: '500px', backgroundColor: '#fffafa', borderRadius: '15px', border: '2px solid #e5e7eb', boxShadow: '0px 2px 5px rgba(0, 0, 0, 0.1)' }}>
